...
# Class: micro_integrator_master
# Init class of Micro Integrator
class micro_integrator_master inherits micro_integrator_master::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> micro_integrator_master -> files
  */
